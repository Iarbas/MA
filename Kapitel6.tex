...
\end{axis}
\end{tikzpicture}
\caption{Mittelwert der RSSI-Werte von allen Distanzen und allen Beacons mit dem Vergleich zu dem berechneten RSSI-Wert aus dem WINNER II-Modell}
...
\end{axis}
\end{tikzpicture}
\caption{Vergleich der durschnittlichen Distanz-Schätzung mit dem WINNER II-Modell zur realen Entfernung}
...
\end{axis}
\end{tikzpicture}
\caption{Mittelwert der Wahrscheinlichkeiten gültiger Signale in einem Toleranzbereich von $2$ Metern, von allen Distanzen und allen Beacons im Verbund zu deren Approximation}
\label{fig:GueteSauelengraph05}
\end{figure} 
